    ...
    return (
        ...
        >
            <motion.div
                ...
                key={props.item.id}
                className="bg-white rounded-2xl relative w-[600px] flex flex-col justify-center gap-4 p-4 shadow-xl"
            >
                <div
                onClick={() => props.onShowItem(props.item)}
                className=" cursor-pointer absolute top-2 right-2 md:right-[-3rem] bg-white rounded-full">
